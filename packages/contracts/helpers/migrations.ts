...
import { CONTRACT_NAME, CONTRACT_SYMBOL, OWNER_ADDRESS, FEE_BPS, LAST_TOKEN_ID } from "./constants";
...
export const deployLetters = async () => {
  ...
  const contract = await Contract.deploy(CONTRACT_NAME, CONTRACT_SYMBOL, OWNER_ADDRESS, LAST_TOKEN_ID, FEE_BPS, {
    gasPrice,
  });
